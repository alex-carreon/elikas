      ...
      toast.promise(response, {
        ...
        error: (err: any) => {
          ...
          if (
            ...
            "SQLSTATE[23000]: Integrity constraint violation: 1062 Duplicate entry 'new' for key 'template_name' (Connection: mysql, Host: REDACTED_TAILSCALE_IP, Port: 3306, Database: elikas_db, SQL: insert into `SMSTemplates` (`optr_id`, `template_name`, `message_content`) values (6, new, bnew))"
          ) {
