...
```
MEDIA_BASE_URL=http://REDACTED_TAILSCALE_IP/uploads   ← correct
MEDIA_BASE_URL=http://REDACTED_TAILSCALE_IP/uploads/  ← produces double slash
```
...
```json
{
    ...
    "media": [
        {
            "id": 9,
            "url": "http://REDACTED_TAILSCALE_IP/uploads/evac-areas/809f4cc8-7b20-4dfb-9e24-ffb8a4cb05ea.jpg",
            "type": "jpg"
        }
    ]
}
